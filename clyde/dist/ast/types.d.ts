...
export type Statement = AssignmentStatement | CompoundAssignmentStatement | FunctionCallStatement | DoStatement | WhileStatement | RepeatStatement | IfStatement | ForNumericStatement | ForInStatement | FunctionStatement | LocalFunctionStatement | LocalStatement | TypeStatement | ExportTypeStatement | TypeFunctionStatement | ExportTypeFunctionStatement;
export type LastStatement = ReturnStatement | BreakStatement | ContinueStatement;
...
export type Expression = Identifier | NilLiteral | BooleanLiteral | NumberLiteral | StringLiteral | StringInterpolation | VarargExpression | BinaryExpression | UnaryExpression | CallExpression | MethodCallExpression | IndexExpression | MemberExpression | TableConstructor | FunctionExpression | ParenExpression | TypeAssertion | IfElseExpression;
...
export type Var = Identifier | IndexExpression | MemberExpression;
...
export type Type = NilType | SingletonType | IdentifierType | TypeofType | TableType | FunctionType | ParenType | UnionType | IntersectionType;
...
export type SimpleTypeWithOptional = {
    type: Type;
    optional?: boolean;
};
...
export interface GenericTypeListWithDefaults extends BaseNode {
    ...
    params: {
        name: string;
        default?: Type | TypePack | VariadicTypePack | GenericTypePack;
    }[];
}
