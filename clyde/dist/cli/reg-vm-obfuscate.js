...
const fileArgs = args.filter((a, i) => !a.startsWith("-") && (outIndex < 0 || i < outIndex || i > outIndex + 1) && (wmIndex < 0 || i < wmIndex || i > wmIndex + 1));
...
//# sourceMappingURL=reg-vm-obfuscate.js.map