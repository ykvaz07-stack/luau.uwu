...
const PRESERVED_GLOBALS = new Set([
    ...
    "print", "warn", "error", "assert", "os", "wait", "spawn",
    ...
    "getloadedmodules", "getcallingscript", "getrunservice", "gethui",
    "getsynasset", "synrequest", "syn", "crypt",
    "Drawing", "base64",
...
function generateUnicodeName(index) {
