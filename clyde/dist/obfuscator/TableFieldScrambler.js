...
function scrambleTable(t, rng, addFake) {
...
function transformExpression(exp, rng, addFake) {
    ...
    if (exp.type === "StringInterpolation") {
        return {
            ...exp,
            parts: exp.parts.map((p) => typeof p === "string" ? p : transformExpression(p, rng, addFake)),
        };
    }
    return exp;
}
function transformStatement(stmt, rng, addFake) {
    switch (stmt.type) {
        case "LocalStatement":
            return {
                ...stmt,
        ...
        case "FunctionCallStatement":
            return { ...stmt, call: transformExpression(stmt.call, rng, addFake) };
...
export function scrambleTableFields(ast, options = {}) {
...
//# sourceMappingURL=TableFieldScrambler.js.map