...
export const ROBOX_RE_TOOL_NAMES = [
 ...
 */
export function emitRobloxAntiDebug(cfg, abortVarName, rng = Math.random) {
    const lines = [];
...
//# sourceMappingURL=RobloxAntiDebug.js.map