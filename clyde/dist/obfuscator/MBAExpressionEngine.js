    ...
    createIdentityOpaque(loc) {
        ...
        switch (variant) {
            case 0: {
                ...
                return {
                    condition: binExp(binExp(binExp(intExp(x, l), "+", intExp(1, l), l), "*", binExp(intExp(x, l), "-", intExp(1, l), l), l), "==", binExp(binExp(intExp(x * x, l), "-", intExp(1, l), l), "+", intExp(0, l), l), l),
                    expected: true,
                };
            }
            case 1: {
                ...
                const lhs = binExp(binExp(intExp(a, l), "+", intExp(b, l), l), "^", intExp(2, l), l);
                const rhs = binExp(binExp(binExp(intExp(a * a, l), "+", binExp(intExp(2 * a * b, l), "+", intExp(b * b, l), l), l), "+", intExp(0, l), l), "-", intExp(0, l), l);
            ...
            case 2: {
                ...
                const lhs = binExp(binExp(intExp(a, l), "-", intExp(b, l), l), "^", intExp(2, l), l);
                const rhs = binExp(binExp(intExp(a * a, l), "-", binExp(intExp(2 * a * b, l), "+", intExp(b * b, l), l), l), "+", intExp(0, l), l);
                return { condition: binExp(lhs, "==", rhs, l), expected: true };
            }
            case 3: {
                ...
                const inner = binExp(binExp(intExp(a * a, l), "+", binExp(intExp(a * b, l), "+", intExp(b * b, l), l), l), "+", intExp(0, l), l);
                const rhs = binExp(binExp(intExp(a, l), "-", intExp(b, l), l), "*", inner, l);
                return { condition: binExp(lhs, "==", rhs, l), expected: true };
            }
            case 4: {
                ...
                return {
                    condition: binExp(binExp(intExp(powApprox, l), "%", intExp(x, l), l), "==", intExp(0, l), l),
                    expected: true,
                };
            }
            case 5: {
                ...
                return {
                    condition: binExp(binExp(intExp(2, l), "*", sum, l), "==", binExp(sum, "*", intExp(2, l), l), l),
                    expected: true,
                };
            }
            case 6: {
                ...
                return {
                    condition: binExp(binExp(binExp(intExp(a & b, l), "|", binExp(intExp(a, l), "&", notB, l), l), "+", intExp(0, l), l), "==", binExp(intExp(a, l), "+", intExp(0, l), l), l),
                    expected: true,
                };
            }
            default: {
                ...
                return {
                    condition: binExp(binExp(binExp(intExp(a, l), "|", intExp(b, l), l), "+", binExp(intExp(a, l), "&", intExp(b, l), l), l), "==", binExp(intExp(a, l), "+", intExp(b, l), l), l),
                    expected: true,
                };
            }
        }
    }
    createVMBasedOpaque(vmProps, loc) {
        const l = cloneLoc(loc);
        ...
        switch (variant) {
            case 0: {
                const a = this.randInt(1, 100);
                const b = this.randInt(1, 100);
                return binExp(binExp(intExp(a, l), "+", intExp(b, l), l), "==", binExp(intExp(a + b, l), "+", intExp(0, l), l), l);
            }
            case 1: {
                const a = this.randInt(2, 50);
                const b = this.randInt(2, 50);
                return binExp(binExp(intExp(a, l), "*", intExp(b, l), l), ">=", binExp(intExp(a, l), "+", intExp(b, l), l), l);
            }
            case 2: {
                const a = this.randInt(1, 255);
                return binExp(binExp(intExp(a, l), "~", intExp(a, l), l), "==", intExp(0, l), l);
            }
            case 3: {
                const a = this.randInt(2, 10);
                const b = this.randInt(2, 10);
                const lhs = binExp(intExp(a, l), "|", intExp(b, l), l);
                const rhs = binExp(intExp(a, l), "&", intExp(b, l), l);
                return binExp(binExp(lhs, "-", rhs, l), "==", binExp(intExp(a, l), "~", intExp(b, l), l), l);
            }
            case 4: {
                const a = this.randInt(1, 10);
                const b = this.randInt(1, 10);
                return binExp(binExp(intExp(a * a, l), "-", intExp(b * b, l), l), "==", binExp(binExp(intExp(a, l), "-", intExp(b, l), l), "*", binExp(intExp(a, l), "+", intExp(b, l), l), l), l);
            }
            default: {
