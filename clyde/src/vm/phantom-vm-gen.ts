...
export function generatePhantomVM(
  ...
  for (let h = 0; h < PHANTOM_OP_COUNT; h++) {
    const oi = opShuf[h];
    const body: string[] = [];
    const ra = (param: string) => `${nRegs}[${param}+1]`;
    for (let j = 0; j < Math.floor(rn() * 4); j++) body.push(`local ${rname(true)}=${Math.floor(rn() * 255)}`);
    switch (oi) {
      case 0: body.push(`--`); break;
      case 1: body.push(`${ra(nA)}=${nRegs}[${nB}+1]`); break;
      case 2: body.push(`${ra(nA)}=${nL}[${nB}+1]`); break;
      case 3: body.push(`${ra(nA)}=nil`); break;
      case 4: body.push(`${ra(nA)}=${nB}~=0`); break;
      case 5: body.push(`${ra(nA)}=rawget(_G,${nL}[${nB}+1])`); break;
      case 6: body.push(`_G[${nL}[${nA}+1]]=${ra(nB)}`); break;
      case 7: body.push(`${ra(nA)}=${nRegs}[${nB}+1][${nRegs}[${nC}+1]]`); break;
      case 8: body.push(`${nRegs}[${nA}+1][${nRegs}[${nB}+1]]=${ra(nC)}`); break;
      case 9: body.push(`${ra(nA)}={}`); break;
      case 10: body.push(`${ra(nA)}=${nRegs}[${nB}+1]+${nRegs}[${nC}+1]`); break;
      case 11: body.push(`${ra(nA)}=${nRegs}[${nB}+1]-${nRegs}[${nC}+1]`); break;
      case 12: body.push(`${ra(nA)}=${nRegs}[${nB}+1]*${nRegs}[${nC}+1]`); break;
      case 13: body.push(`${ra(nA)}=${nRegs}[${nB}+1]/${nRegs}[${nC}+1]`); break;
      case 14: body.push(`${ra(nA)}=${nRegs}[${nB}+1]%${nRegs}[${nC}+1]`); break;
      case 15: body.push(`${ra(nA)}=${nRegs}[${nB}+1]^${nRegs}[${nC}+1]`); break;
      case 16: body.push(`${ra(nA)}=-${nRegs}[${nB}+1]`); break;
      case 17: body.push(`${ra(nA)}=not ${nRegs}[${nB}+1]`); break;
      case 18: body.push(`${ra(nA)}=#${nRegs}[${nB}+1]`); break;
      case 19: body.push(`local _s=tostring(${nRegs}[${nB}+1]);for _i=${nB}+2,${nC}+1 do _s=_s..tostring(${nRegs}[_i]) end;${nRegs}[${nA}+1]=_s`); break;
      case 20: body.push(`if ${nB}==0 or (${nC}~=0)==not not ${nRegs}[${nB}+1] then return ${nI}+${nA}*4-4 end`); break;
      case 21: body.push(`${ra(nA)}=${nRegs}[${nB}+1]==${nRegs}[${nC}+1]`); break;
      case 22: body.push(`${ra(nA)}=${nRegs}[${nB}+1]<${nRegs}[${nC}+1]`); break;
      case 23: body.push(`${ra(nA)}=${nRegs}[${nB}+1]<=${nRegs}[${nC}+1]`); break;
      case 24: body.push(`${ra(nA)}=${nRegs}[${nB}+1]`); break;
      ...
      case 29: body.push(`${nRegs}[${nA}+1]=${nRegs}[${nA}+1]-${nRegs}[${nA}+3];if ${nRegs}[${nA}+1]>${nRegs}[${nA}+2] then return ${nI}+${nC}*4-4 end`); break;
      case 30: body.push(`${nRegs}[${nA}+1]=${nRegs}[${nA}+1]+${nRegs}[${nA}+3];if ${nRegs}[${nA}+1]<=${nRegs}[${nA}+2] then return ${nI}-${nB}*4 end`); break;
      case 31: {
      ...
      case 33: body.push(`${ra(nA)}=${nFt}[${nB}+1]`); break;
      case 34: body.push(`for _i=1,${nVn} do ${nRegs}[${nA}+_i]=${nVg}[_i] end`); break;
      case 35: body.push(`${ra(nA)}=${nRegs}[${nB}+1]`); break;
